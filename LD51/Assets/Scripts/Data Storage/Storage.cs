...
public abstract class Storage {
  ...
  public abstract bool GetBool(string key, bool fallback);
  public abstract float GetFloat(string key, float fallback);
  public abstract string GetString(string key, string fallback);
  public abstract Vector2 GetVector2(string key, Vector2 fallback);
  public abstract Vector3 GetVector3(string key, Vector3 fallback);
